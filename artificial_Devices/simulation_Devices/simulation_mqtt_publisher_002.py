...
while True:
    ...
    if isinstance(offsets[0], float):    
        ...
        sinus_value1 = round(amplitude1 * math.sin(angle1) + offsets[0] * random.uniform(0.96, 1.04), 4)
    ...
    if isinstance(offsets[1], float):
        ...
        sinus_value2 = round(amplitude2 * math.sin(angle2) + offsets[1] * random.uniform(0.96, 1.04), 4)
    ...
    if isinstance(offsets[2], float):
        ...
        sinus_value3 = round(amplitude3 * math.sin(angle3) + offsets[2] * random.uniform(0.96, 1.04), 4)
